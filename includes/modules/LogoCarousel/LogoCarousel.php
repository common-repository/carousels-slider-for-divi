...
class DCS_LogoCarousel extends ET_Builder_Module {
	...
	public function init() {
		$this->name = esc_html__( 'Logo Carousel', $this->$text_domain );
            ...
            'general' => array(
				...
				'advanced' => array(
					'toggles' => array(
						...
						// 'carousel_heading_settings' => esc_html__( 'Title', $this->$text_domain ),
						// 'carousel_content_settings' => esc_html__( 'Content', $this->$text_domain ),
						// 'carousel_image_icon_settings' => array('title' => esc_html__( 'Image/Icon', $this->$text_domain ),),
						'carousel_button_settings' => esc_html__( 'Read More', $this->$text_domain ),
	...
	public function get_advanced_fields_config() {
        return array(
			...
			// 	'learnmore' => array(
            //         'css' => array(
            //             'main' => '%%order_class%% .carousel_content a',
			// 			'important' => 'all'
            //         ),
            ...
            'borders' => array(
                'default' => array(
                    'css'          => array(
						'main' => array(
							'border_radii'  => '%%order_class%% .divi8_content_carousel_item',
							'border_styles' => '%%order_class%% .divi8_content_carousel_item',
                        ),
                    ),
                ),
                // 'image_border'   => array(
				...
				// 	'toggle_slug'  => 'carousel_content_settings',
				// ),
				// 'learnmore_border'   => array(
				// 	'css'          => array(
				// 		'main' => array(
				// 			'border_radii'  => '%%order_class%% .carousel_content a',
				// 			'border_styles' => '%%order_class%% .carousel_content a',
                //         ),
                //     ),
				// 	'label_prefix' => esc_html__( 'Learn More', $this->$text_domain ),
				// 	'tab_slug'     => 'advanced',
				// 	'toggle_slug'  => 'carousel_button_settings',
				// ),
            ),
	...
	public function get_fields() {
		...
		// 	'label'           		=> esc_html__('Title Padding', $this->$text_domain),
		// 	'type'            		=> 'custom_padding',
		// 	'mobile_options'  		=> true,
		// 	'hover'           		=> 'tabs',
		// 	'allowed_units'   		=> array( '%', 'em', 'rem', 'px', 'cm', 'mm', 'in', 'pt', 'pc', 'ex', 'vh', 'vw' ),
		...
		// 	'label'           		=> esc_html__('Title Margin', $this->$text_domain),
		// 	'type'            		=> 'custom_margin',
		// 	'mobile_options'  		=> true,
		// 	'hover'           		=> 'tabs',
		// 	'allowed_units'   		=> array( '%', 'em', 'rem', 'px', 'cm', 'mm', 'in', 'pt', 'pc', 'ex', 'vh', 'vw' ),
		...
		// 	'label'           		=> esc_html__('Content Padding', $this->$text_domain),
		// 	'type'            		=> 'custom_padding',
		// 	'mobile_options'  		=> true,
		// 	'hover'           		=> 'tabs',
		// 	'allowed_units'   		=> array( '%', 'em', 'rem', 'px', 'cm', 'mm', 'in', 'pt', 'pc', 'ex', 'vh', 'vw' ),
		...
		// 	'label'           		=> esc_html__('Content Margin', $this->$text_domain),
		// 	'type'            		=> 'custom_margin',
		// 	'mobile_options'  		=> true,
		// 	'hover'           		=> 'tabs',
		// 	'allowed_units'   		=> array( '%', 'em', 'rem', 'px', 'cm', 'mm', 'in', 'pt', 'pc', 'ex', 'vh', 'vw' ),
	...
	public function apply_css($render_slug){
		...
		*/
		...
		// BaseDCSCarousel::basecarouse8_set_style($render_slug, $this->props, "divi8_learmore_padding", "%%order_class%% .carousel_content a", "padding");
		// BaseDCSCarousel::basecarouse8_set_style($render_slug, $this->props, "divi8_learmore_margin", "%%order_class%% .carousel_content a", "margin");
